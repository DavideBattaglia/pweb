...
@WebServlet("/DisplayConcerti")
public class DisplayConcertiServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            request.getRequestDispatcher(response.encodeURL("/concerti.jsp")).forward(request, response);
